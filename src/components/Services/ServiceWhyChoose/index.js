...
const ServiceWhyChoose = () => {
  return (
    <section className="service-why-choose" style={{ background: "no-repeat center/cover url('https://www.wellnessclinicmarketing.com/wp-content/uploads/2024/12/fb-ads-sec3.jpg')" }}>
      <div className="cus-container">
        ...
        <div className="why-choose-list">
          ...
          <div class="w-box position-relative ast-flex justify-content-center">
            <div class="inner ast-flex flex-column">
              ...
              <figure><img src="https://www.wellnessclinicmarketing.com/wp-content/uploads/2024/12/fb-ads-2.png" alt="Drive ad reach to the right <br>people at the right time." /></figure>
            </div>
          </div>
        ...
        <div class="sc-btn ast-flex justify-content-center">
          <a href="https://www.wellnessclinicmarketing.com/get-started-b/" target="_self" class="btn-bg bg-F2771A btn-size-18 fw-700">Schedule A Strategy Session</a>
        </div>
      </div>
    </section>
  )
