...
const Header = ({ to }) => {
  ...
  return (
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/website-development`}>
    //                                       Website Development
    //                                     </Link>
    //                                   </li>
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/facebook-advertising`}>
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/search-engine-optimization`}>
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/lead-management`}>
    //                                       Lead Management (CRM)
    //                                     </Link>
    //                                   </li>
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/google-maps-marketing`}>
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/reputation-management`}>
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/google-advertising`}>
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/aesthetic-marketing`}>
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/anti-aging-marketing`}>
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/medical-weight-loss-marketing`}>
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/sexual-health-marketing`}>
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/hormone-clinic-marketing`}>
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/wellness-medical-clinic-marketing`}>
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/mens-health-clinic-marketing`}>
    ...
    //                                     <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/med-spa-marketing`}>
    //                                       Med Spa Marketing
    //                                     </Link>
    //                                   </li>
    //                                 </ul>
    ...
    //                         <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/our-method-mars`} tabIndex={0}>
    //                           Method
    //                         </Link>
    //                       </li>
    ...
    //                         <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/about-us`} aria-expanded="false" tabIndex={0}>
    //                           About Us
    //                           <span className="mega-indicator" aria-hidden="true"> </span>
    //                         </Link>
    //                         <ul className="mega-sub-menu">
    ...
    //                             <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/our-team`}>
    //                               Our Team
    //                             </Link>
    //                           </li>
    ...
    //                             <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/events`}>
    //                               Events
    //                             </Link>
    //                           </li>
    ...
    //                             <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/webinars`}>
    //                               Webinars
    //                             </Link>
    //                           </li>
    ...
    //                             <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/podcast`}>
    //                               Podcasts
    //                             </Link>
    //                           </li>
    ...
    //                             <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/blogs`}>
    //                               Blogs
    //                             </Link>
    //                           </li>
    //                         </ul>
    ...
    //                   <Link className="ast-custom-button-link" to={`${process.env.REACT_APP_BASE_URL}/get-started`} target="_self">
    //                     <div className="ast-custom-button">Get Started</div>
    //                   </Link>
    //                   <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/get-started`} target="_self">
    //                     Get Started
    //                   </Link>
    //                 </div>
    //               </div>
    ...
    <header className="site-header header-main-layout-1 ast-primary-menu-enabled ast-hide-custom-menu-mobile ast-builder-menu-toggle-icon ast-mobile-header-inline" id="masthead" itemType="https://schema.org/WPHeader" itemScope="itemscope" itemID="#masthead">
            ...
            <div className="site-primary-header-wrap ast-builder-grid-row-container site-header-focus-item ast-container" data-section="section-primary-header-builder">
              <div className="ast-builder-grid-row ast-builder-grid-row-has-sides ast-builder-grid-row-no-center">
                ...
                <div className="site-header-primary-section-right site-header-section ast-flex ast-grid-right-section">
                    ...
                    <div className="ast-main-header-bar-alignment">
                      <div id="mega-menu-wrap-primary" className="mega-menu-wrap">
                        <div className="mega-menu-toggle">
                          ...
                          <div className="mega-toggle-blocks-center" />
                          <div className="mega-toggle-blocks-right">
                            <div className="mega-toggle-block mega-menu-toggle-animated-block mega-toggle-block-0" id="mega-toggle-block-0"><button aria-label="Toggle Menu" className="mega-toggle-animated mega-toggle-animated-slider" type="button" aria-expanded="false"> <span className="mega-toggle-animated-box nitro-lazy"> <span className="mega-toggle-animated-inner" /> </span> </button></div>
                          </div>
                        </div>
                        <ul id="mega-menu-primary" className="mega-menu max-mega-menu mega-menu-horizontal" data-event="hover_intent" data-effect="fade_up" data-effect-speed={200} data-effect-mobile="disabled" data-effect-speed-mobile={0} data-mobile-force-width="false" data-second-click="go" data-document-click="collapse" data-vertical-behaviour="standard" data-breakpoint={768} data-unbind="true" data-mobile-state="collapse_all" data-mobile-direction="vertical" data-hover-intent-timeout={300} data-hover-intent-interval={100}>
                          <li className="mega-full-w-columns mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-menu-item-has-children mega-menu-megamenu mega-menu-grid mega-align-bottom-left mega-menu-grid mega-menu-item-31 full-w-columns" id="mega-menu-item-31">
                              ...
                              <li className="mega-menu-row mega-menu-cols2-style menu-cols2-style" id="mega-menu-1641-0">
                                <ul className="mega-sub-menu" style={{ "--columns": "12" }} role="presentation">
                                  <li className="mega-menu-column mega-menu-columns-6-of-12 mega-hide-on-mobile" style={{ "--span": "6" }} id="mega-menu-1641-0-0">
                                    <ul className="mega-sub-menu">
                                      <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-1644" id="mega-menu-item-1644">
                                        <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/medical-weight-loss-marketing`}>Medical Weight Loss Marketing</Link>
                                      </li>
                                      <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-1645" id="mega-menu-item-1645">
                                        <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/sexual-health-marketing`}>Sexual Health Marketing</Link>
                                      </li>
                                      <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-2617" id="mega-menu-item-2617">
                                        <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/multi-location-marketing`}>Multi-Location Clinic Marketing</Link>
                                      </li>
                                      <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-2033" id="mega-menu-item-2033">
                                        <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/med-spa-marketing`}>Medspa Marketing</Link>
                                      </li>
                                      <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-3429" id="mega-menu-item-3429">
                                        <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/franchise-marketing`}>Franchise Marketing</Link>
                                      </li>
                                    </ul>
                                  </li>
                                  <li className="mega-menu-column mega-menu-columns-6-of-12 mega-hide-on-mobile" style={{ "--span": "6" }} id="mega-menu-1641-0-1">
                                    <ul className="mega-sub-menu">
                                      <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-1643" id="mega-menu-item-1643">
                                        <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/hormone-clinic-marketing`}>Hormone Optimization Marketing</Link>
                                      </li>
                                      <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-2031" id="mega-menu-item-2031">
                                        <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/wellness-medical-clinic-marketing`}>Medical Wellness Clinic Marketing</Link>
                                      </li>
                                      <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-2032" id="mega-menu-item-2032">
                                        <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/mens-health-clinic-marketing`}>Men’s Health Clinic Marketing</Link>
                                      </li>
                                      <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-3343" id="mega-menu-item-3343">
                                        <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/ai-search-optimization`}>AI Search Optimization</Link>
                                      </li>
                                    </ul>
                                  </li>
                                </ul>
                          ...
                          <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-align-bottom-left mega-menu-flyout mega-menu-item-2155" id="mega-menu-item-2155"><a className="mega-menu-link" href="https://www.wellnessclinicmarketing.com/our-method-mars/" tabIndex={0}>Method</a></li>
                          <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-has-children mega-align-bottom-left mega-menu-flyout mega-menu-item-372" id="mega-menu-item-372">
                            <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/about-us`} aria-expanded="false" tabIndex={0}>
                              About Us
                            ...
                            <ul className="mega-sub-menu">
                              <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-409" id="mega-menu-item-409">
                                <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/our-team`}>Our Team</Link>
                              </li>
                              <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-408" id="mega-menu-item-408">
                                <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/events`}>Events</Link>
                              </li>
                              <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-941" id="mega-menu-item-941">
                                <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/webinars`}>Webinars</Link>

                              </li>
                              <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-942" id="mega-menu-item-942">
                                <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/podcast`}>Podcasts</Link>
                              </li>
                              <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2736" id="mega-menu-item-2736">
                                <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/case-study`}>Case Studies</Link>
                              </li>
                              <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-1263" id="mega-menu-item-1263">
                                <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/blogs`}>Blogs</Link>
                              </li>
                              <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2853" id="mega-menu-item-2853">
                                <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/in-the-news`}>In The News</Link>
                              </li>
                            </ul>
                          </li>
                          <li className="mega-hide-mobile mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-align-bottom-left mega-menu-flyout mega-menu-item-2177 hide-mobile" id="mega-menu-item-2177">
                  ...
                  <div className="ast-builder-layout-element ast-flex site-header-focus-item ast-header-button-1" data-section="section-hb-button-1">
                    <div className="ast-builder-button-wrap ast-builder-button-size-default">
                      <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/get-started`} target="_self" role="button" aria-label="Get Started">
                        <div className="ast-custom-button">Get Started</div>
                      </Link>
                      <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/get-started`} target="_self" >Get Started</Link>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="ast-above-header-bar ast-above-header site-above-header-wrap site-header-focus-item ast-builder-grid-row-layout-default ast-builder-grid-row-tablet-layout-default ast-builder-grid-row-mobile-layout-default" data-section="section-above-header-builder">
            <div className="ast-builder-grid-row ast-builder-grid-row-has-sides ast-builder-grid-row-no-center">
              ...
              <div className="site-header-above-section-right site-header-section ast-flex ast-grid-right-section">
                <div className="ast-builder-layout-element ast-flex site-header-focus-item ast-header-button-1" data-section="section-hb-button-1">
                  <div className="ast-builder-button-wrap ast-builder-button-size-default">
                    <Link className="ast-custom-button-link" to={`${process.env.REACT_APP_BASE_URL}/get-started`} target="_self" role="button" aria-label="Get Started">
                      <div className="ast-custom-button">Get Started</div>
                    </Link>
                    <a className="menu-link" href="https://www.wellnessclinicmarketing.com/get-started/" target="_self">
                      Get Started
                    </a>
                  </div>
                </div>
                ...
                <nav className="site-navigation ast-flex-grow-1 navigation-accessibility site-header-focus-item" id="ast-mobile-site-navigation" aria-label="Site Navigation: Primary Menu" itemType="https://schema.org/SiteNavigationElement" itemScope="itemscope">
                  <div className="main-navigation">
                    <ul id="ast-hf-mobile-menu" className="main-header-menu ast-nav-menu ast-flex  submenu-with-border astra-menu-animation-fade  stack-on-mobile ast-mega-menu-enabled">
                      <li id="menu-item-31" className="full-w-columns menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-31">
                        ...
                        <ul className="sub-menu">
                          <li id="menu-item-857" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-857">
                            <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/website-development`}>
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-858" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-858">
                            <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/facebook-advertising`}>
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-859" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-859">
                            <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/search-engine-optimization`}>
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-860" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-860">
                            <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/lead-management`}>
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-861" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-861">
                            <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/google-maps-marketing`}>
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-862" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-862">
                            <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/reputation-management`}>
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-863" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-863">
                            <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/google-advertising`}>
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                      ...
                      <li id="menu-item-1641" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1641">
                        <a aria-expanded="false" href="#" className="menu-link">
                          <span className="ast-icon icon-arrow">
                            <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                              <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                        ...
                        <ul className="sub-menu">
                          <li id="menu-item-1644" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-1644">
                            <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/medical-weight-loss-marketing`}>
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-1645" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-1645">
                            <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/sexual-health-marketing`}>
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-1643" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-1643">
                            <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/hormone-clinic-marketing`}>
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-2031" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-2031">
                            <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/hormone-clinic-marketing`}>
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                          ...
                          <li id="menu-item-2032" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-2032">
                            <Link to={`${process.env.REACT_APP_BASE_URL}/service/mens-health-clinic-marketing`} className="menu-link">
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-2033" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-2033">
                            <Link to={`${process.env.REACT_APP_BASE_URL}/service/med-spa-marketing`} className="menu-link">
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-2617" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-2617">
                            <Link to={`${process.env.REACT_APP_BASE_URL}/service/multi-location-marketing`} className="menu-link">
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-3343" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-3343">
                            <Link to={`${process.env.REACT_APP_BASE_URL}/service/ai-search-optimization`} className="menu-link">
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-3429" className="menu-item menu-item-type-post_type menu-item-object-service menu-item-3429">
                            <Link to={`${process.env.REACT_APP_BASE_URL}/service/franchise-marketing`} className="menu-link">
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                      ...
                      <li id="menu-item-2155" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2155">
                        <Link to={`${process.env.REACT_APP_BASE_URL}/our-method-mars`} className="menu-link">
                          <span className="ast-icon icon-arrow">
                            <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                              <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                            </svg>
                      ...
                      <li id="menu-item-372" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-372">
                        <Link aria-expanded="false" href="https://www.wellnessclinicmarketing.com/about-us/" className="menu-link">
                          <span className="ast-icon icon-arrow">
                            <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                              <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                            </svg>
                        ...
                        <ul className="sub-menu">
                          <li id="menu-item-409" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-409">
                            <Link to={`${process.env.REACT_APP_BASE_URL}/our-team`} className="menu-link">
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-408" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-408">
                            <Link to={`${process.env.REACT_APP_BASE_URL}/events`} className="menu-link">
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-941" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-941">
                            <Link to={`${process.env.REACT_APP_BASE_URL}/webinars`} className="menu-link">
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-942" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-942">
                            <Link to={`${process.env.REACT_APP_BASE_URL}/podcast`} className="menu-link">
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-2736" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2736">
                            <Link to={`${process.env.REACT_APP_BASE_URL}/case-study`} className="menu-link">
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-1263" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1263">
                            <Link to={`${process.env.REACT_APP_BASE_URL}/blogs`} className="menu-link">
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                          ...
                          <li id="menu-item-2853" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2853">
                            <Link to={`${process.env.REACT_APP_BASE_URL}/in-the-news`} className="menu-link">
                              <span className="ast-icon icon-arrow">
                                <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                  <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                </svg>
                      ...
                      <li id="menu-item-2177" className="hide-mobile menu-item menu-item-type-custom menu-item-object-custom menu-item-2177">
      ...
      <header id="ast-fixed-header" className="site-header header-main-layout-1 ast-primary-menu-enabled ast-hide-custom-menu-mobile ast-builder-menu-toggle-icon ast-mobile-header-inline ast-sticky-shrunk" style={{ "visibility": "hidden" }} data-type="fixed-header">
        <div id="ast-desktop-header" data-toggle-type="dropdown">
          <div className="ast-main-header-wrap main-header-bar-wrap ">
            <div className="ast-primary-header-bar ast-primary-header main-header-bar site-header-focus-item" data-section="section-primary-header-builder">
              <div className="site-primary-header-wrap ast-builder-grid-row-container site-header-focus-item ast-container" data-section="section-primary-header-builder">
                <div className="ast-builder-grid-row ast-builder-grid-row-has-sides ast-builder-grid-row-no-center">
                  ...
                  <div className="site-header-primary-section-right site-header-section ast-flex ast-grid-right-section">
                      ...
                      <div className="ast-main-header-bar-alignment">
                        <div id="mega-menu-wrap-primary" className="mega-menu-wrap">
                          ...
                          <ul id="mega-menu-primary" className="mega-menu max-mega-menu mega-menu-horizontal" data-event="hover_intent" data-effect="fade_up" data-effect-speed={200} data-effect-mobile="disabled" data-effect-speed-mobile={0} data-mobile-force-width="false" data-second-click="go" data-document-click="collapse" data-vertical-behaviour="standard" data-breakpoint={768} data-unbind="true" data-mobile-state="collapse_all" data-mobile-direction="vertical" data-hover-intent-timeout={300} data-hover-intent-interval={100}>
                              ...
                              <ul className="mega-sub-menu" role="presentation">
                                <li className="mega-menu-row" id="mega-menu-31-0">
                                  <ul className="mega-sub-menu" style={{ "--columns": "12" }} role="presentation">
                                    <li className="mega-menu-column mega-menu-columns-6-of-12" style={{ "--span": "6" }} id="mega-menu-31-0-0">
                                      <ul className="mega-sub-menu">
                                        <li className="mega-menu-item mega-menu-item-type-widget widget_media_image mega-menu-item-media_image-8" id="mega-menu-item-media_image-8"><img alt style={{ "max-width": "100%", "height": "auto" }} nitro-lazy-src="https://cdn-ildkbbb.nitrocdn.com/fkaQeaaaKzvRPORNguIPgjvTQBtCcEbQ/assets/images/optimized/rev-22f84eb/www.wellnessclinicmarketing.com/wp-content/uploads/2024/11/improvement-1.svg" className="image wp-image-238 attachment-full size-full lazyloaded" decoding="async" nitro-lazy-empty id="NDgwOjM0OQ==-1" src="https://cdn-ildkbbb.nitrocdn.com/fkaQeaaaKzvRPORNguIPgjvTQBtCcEbQ/assets/images/optimized/rev-22f84eb/www.wellnessclinicmarketing.com/wp-content/uploads/2024/11/improvement-1.svg" /></li>
                                        <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-857" id="mega-menu-item-857"><a className="mega-menu-link" href="https://www.wellnessclinicmarketing.com/service/website-development/">Website Development</a></li>
                                        <li className="mega-menu-item mega-menu-item-type-widget widget_text mega-menu-item-text-9" id="mega-menu-item-text-9">
                                          <div className="textwidget">
                                            <p>Custom-built websites designed to attract, convert, and educate high-ticket wellness patients.</p>
                                          </div>
                                    ...
                                    <li className="mega-menu-column mega-menu-columns-6-of-12" style={{ "--span": "6" }} id="mega-menu-31-0-1">
                                      <ul className="mega-sub-menu">
                                        <li className="mega-menu-item mega-menu-item-type-widget widget_media_image mega-menu-item-media_image-9" id="mega-menu-item-media_image-9"><img alt style={{ "max-width": "100%", "height": "auto" }} nitro-lazy-src="https://cdn-ildkbbb.nitrocdn.com/fkaQeaaaKzvRPORNguIPgjvTQBtCcEbQ/assets/images/optimized/rev-22f84eb/www.wellnessclinicmarketing.com/wp-content/uploads/2024/11/improvement-5.svg" className="image wp-image-239 attachment-full size-full lazyloaded" decoding="async" nitro-lazy-empty id="NDg1OjM0OQ==-1" src="https://cdn-ildkbbb.nitrocdn.com/fkaQeaaaKzvRPORNguIPgjvTQBtCcEbQ/assets/images/optimized/rev-22f84eb/www.wellnessclinicmarketing.com/wp-content/uploads/2024/11/improvement-5.svg" /></li>
                                        <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-858" id="mega-menu-item-858"><a className="mega-menu-link" href="https://www.wellnessclinicmarketing.com/service/facebook-advertising/">Facebook Advertising</a></li>
                                        <li className="mega-menu-item mega-menu-item-type-widget widget_text mega-menu-item-text-10" id="mega-menu-item-text-10">
                                          <div className="textwidget">
                                            <p>Targeted Facebook ads that drive new patient leads for aesthetics, HRT, and weight loss.</p>
                                          </div>
                                ...
                                <li className="mega-menu-row" id="mega-menu-31-1">
                                  <ul className="mega-sub-menu" style={{ "--columns": "12" }} role="presentation">
                                    <li className="mega-menu-column mega-menu-columns-6-of-12" style={{ "--span": "6" }} id="mega-menu-31-1-0">
                                      <ul className="mega-sub-menu">
                                        <li className="mega-menu-item mega-menu-item-type-widget widget_media_image mega-menu-item-media_image-11" id="mega-menu-item-media_image-11"><img alt style={{ "max-width": "100%", "height": "auto" }} nitro-lazy-src="https://cdn-ildkbbb.nitrocdn.com/fkaQeaaaKzvRPORNguIPgjvTQBtCcEbQ/assets/images/optimized/rev-22f84eb/www.wellnessclinicmarketing.com/wp-content/uploads/2024/11/improvement-2.svg" className="image wp-image-240 attachment-full size-full lazyloaded" decoding="async" nitro-lazy-empty id="NDkzOjM1MQ==-1" src="https://cdn-ildkbbb.nitrocdn.com/fkaQeaaaKzvRPORNguIPgjvTQBtCcEbQ/assets/images/optimized/rev-22f84eb/www.wellnessclinicmarketing.com/wp-content/uploads/2024/11/improvement-2.svg" /></li>
                                        <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-859" id="mega-menu-item-859"><a className="mega-menu-link" href="https://www.wellnessclinicmarketing.com/service/search-engine-optimization/">Search Engine Marketing</a></li>
                                        <li className="mega-menu-item mega-menu-item-type-widget widget_text mega-menu-item-text-11" id="mega-menu-item-text-11">
                                          <div className="textwidget">
                                            <p>Top Google rankings for keywords your ideal patients are already searching.</p>
                                          </div>
                                    ...
                                    <li className="mega-menu-column mega-menu-columns-6-of-12" style={{ "--span": "6" }} id="mega-menu-31-1-1">
                                      <ul className="mega-sub-menu">
                                        <li className="mega-menu-item mega-menu-item-type-widget widget_media_image mega-menu-item-media_image-12" id="mega-menu-item-media_image-12"><img alt style={{ "max-width": "100%", "height": "auto" }} nitro-lazy-src="https://cdn-ildkbbb.nitrocdn.com/fkaQeaaaKzvRPORNguIPgjvTQBtCcEbQ/assets/images/optimized/rev-22f84eb/www.wellnessclinicmarketing.com/wp-content/uploads/2024/11/improvement-6.svg" className="image wp-image-241 attachment-full size-full lazyloaded" decoding="async" nitro-lazy-empty id="NDk4OjM1MQ==-1" src="https://cdn-ildkbbb.nitrocdn.com/fkaQeaaaKzvRPORNguIPgjvTQBtCcEbQ/assets/images/optimized/rev-22f84eb/www.wellnessclinicmarketing.com/wp-content/uploads/2024/11/improvement-6.svg" /></li>
                                        <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-860" id="mega-menu-item-860"><a className="mega-menu-link" href="https://www.wellnessclinicmarketing.com/service/lead-management/">Lead Management (CRM)</a></li>
                                        <li className="mega-menu-item mega-menu-item-type-widget widget_text mega-menu-item-text-12" id="mega-menu-item-text-12">
                                          <div className="textwidget">
                                            <p>Automated tools to capture, nurture, and convert leads into booked appointments.</p>
                                          </div>
                                ...
                                <li className="mega-menu-row" id="mega-menu-31-2">
                                  <ul className="mega-sub-menu" style={{ "--columns": "12" }} role="presentation">
                                    <li className="mega-menu-column mega-menu-columns-6-of-12" style={{ "--span": "6" }} id="mega-menu-31-2-0">
                                      <ul className="mega-sub-menu">
                                        <li className="mega-menu-item mega-menu-item-type-widget widget_media_image mega-menu-item-media_image-13" id="mega-menu-item-media_image-13"><img alt style={{ "max-width": "100%", "height": "auto" }} nitro-lazy-src="https://cdn-ildkbbb.nitrocdn.com/fkaQeaaaKzvRPORNguIPgjvTQBtCcEbQ/assets/images/optimized/rev-22f84eb/www.wellnessclinicmarketing.com/wp-content/uploads/2024/11/improvement-3.svg" className="image wp-image-242 attachment-full size-full lazyloaded" decoding="async" nitro-lazy-empty id="NTA2OjM1MQ==-1" src="https://cdn-ildkbbb.nitrocdn.com/fkaQeaaaKzvRPORNguIPgjvTQBtCcEbQ/assets/images/optimized/rev-22f84eb/www.wellnessclinicmarketing.com/wp-content/uploads/2024/11/improvement-3.svg" /></li>
                                        <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-861" id="mega-menu-item-861"><a className="mega-menu-link" href="https://www.wellnessclinicmarketing.com/service/google-maps-marketing/">Google Maps Marketing</a></li>
                                        <li className="mega-menu-item mega-menu-item-type-widget widget_text mega-menu-item-text-17" id="mega-menu-item-text-17">
                                          <div className="textwidget">
                                            <p>Rank higher locally and get found by patients searching in your area.</p>
                                          </div>
                                    ...
                                    <li className="mega-menu-column mega-menu-columns-6-of-12" style={{ "--span": "6" }} id="mega-menu-31-2-1">
                                      <ul className="mega-sub-menu">
                                        <li className="mega-menu-item mega-menu-item-type-widget widget_media_image mega-menu-item-media_image-16" id="mega-menu-item-media_image-16"><img width={40} height={40} alt style={{ "max-width": "100%", "height": "auto" }} nitro-lazy-src="https://cdn-ildkbbb.nitrocdn.com/fkaQeaaaKzvRPORNguIPgjvTQBtCcEbQ/assets/images/optimized/rev-22f84eb/www.wellnessclinicmarketing.com/wp-content/uploads/2024/12/icon-reputation-management.png" className="image wp-image-864 attachment-full size-full lazyloaded" decoding="async" nitro-lazy-empty id="NTExOjM4Nw==-1" src="https://cdn-ildkbbb.nitrocdn.com/fkaQeaaaKzvRPORNguIPgjvTQBtCcEbQ/assets/images/optimized/rev-22f84eb/www.wellnessclinicmarketing.com/wp-content/uploads/2024/12/icon-reputation-management.png" /></li>
                                        <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-862" id="mega-menu-item-862"><a className="mega-menu-link" href="https://www.wellnessclinicmarketing.com/service/reputation-management/">Reputation Management</a></li>
                                        <li className="mega-menu-item mega-menu-item-type-widget widget_text mega-menu-item-text-15" id="mega-menu-item-text-15">
                                          <div className="textwidget">
                                            <p>Build trust online with automated review requests and 5-star reputation strategies.</p>
                                          </div>
                                ...
                                <li className="mega-menu-row" id="mega-menu-31-3">
                                  <ul className="mega-sub-menu" style={{ "--columns": "12" }} role="presentation">
                                    <li className="mega-menu-column mega-menu-columns-6-of-12" style={{ "--span": "6" }} id="mega-menu-31-3-0">
                                      <ul className="mega-sub-menu">
                                        <li className="mega-menu-item mega-menu-item-type-widget widget_media_image mega-menu-item-media_image-15" id="mega-menu-item-media_image-15"><img alt style={{ "max-width": "100%", "height": "auto" }} nitro-lazy-src="https://cdn-ildkbbb.nitrocdn.com/fkaQeaaaKzvRPORNguIPgjvTQBtCcEbQ/assets/images/optimized/rev-22f84eb/www.wellnessclinicmarketing.com/wp-content/uploads/2024/11/improvement-4.svg" className="image wp-image-244 attachment-full size-full lazyloaded" decoding="async" nitro-lazy-empty id="NTE5OjM1MQ==-1" src="https://cdn-ildkbbb.nitrocdn.com/fkaQeaaaKzvRPORNguIPgjvTQBtCcEbQ/assets/images/optimized/rev-22f84eb/www.wellnessclinicmarketing.com/wp-content/uploads/2024/11/improvement-4.svg" /></li>
                                        <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-863" id="mega-menu-item-863"><a className="mega-menu-link" href="https://www.wellnessclinicmarketing.com/service/google-advertising/">Google Paid Advertising</a></li>
                                        <li className="mega-menu-item mega-menu-item-type-widget widget_text mega-menu-item-text-14" id="mega-menu-item-text-14">
                                          <div className="textwidget">
                                            <p>High-converting Google Ads campaigns tailored to cash-pay medical wellness practices.</p>
                                          </div>
                                  ...
                                  <ul className="mega-sub-menu" style={{ "--columns": "12" }} role="presentation">
                                    <li className="mega-menu-column mega-menu-columns-6-of-12 mega-hide-on-mobile" style={{ "--span": "6" }} id="mega-menu-1641-0-0">
                                      <ul className="mega-sub-menu">
                                        ...
                                        <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-2617" id="mega-menu-item-2617">
                                          <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/multi-location-marketing`}>
                                        ...
                                        <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-3429" id="mega-menu-item-3429">
                                          <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/franchise-marketing`}>
                                            Franchise Marketing
                                          </Link>
                                        </li>
                                      </ul>
                                    ...
                                    <li className="mega-menu-column mega-menu-columns-6-of-12 mega-hide-on-mobile" style={{ "--span": "6" }} id="mega-menu-1641-0-1">
                                      <ul className="mega-sub-menu">
                                        ...
                                        <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-service mega-menu-item-3343" id="mega-menu-item-3343">
                                          <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/ai-search-optimization`}>
                            ...
                            <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-align-bottom-left mega-menu-flyout mega-menu-item-2155" id="mega-menu-item-2155"><a className="mega-menu-link" href="https://www.wellnessclinicmarketing.com/our-method-mars/" tabIndex={0}>Method</a></li>
                            <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-has-children mega-align-bottom-left mega-menu-flyout mega-menu-item-372" id="mega-menu-item-372">
                              <a className="mega-menu-link" href="https://www.wellnessclinicmarketing.com/about-us/" aria-expanded="false" tabIndex={0}>About Us<span className="mega-indicator" aria-hidden="true" /></a>
                              <ul className="mega-sub-menu">
                                <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-409" id="mega-menu-item-409">
                                  <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/our-team`}>
                                    Our Team
                                ...
                                <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2736" id="mega-menu-item-2736">
                                  <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/case-study`}>
                                    Case Studies
                                  </Link>
                                </li>
                                <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-1263" id="mega-menu-item-1263">
                                ...
                                <li className="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2853" id="mega-menu-item-2853">
                                  <Link className="mega-menu-link" to={`${process.env.REACT_APP_BASE_URL}/in-the-news`}>
                                    In The News
                                  </Link>
                                </li>
                              </ul>
                            </li>
                            <li className="mega-hide-mobile mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-align-bottom-left mega-menu-flyout mega-menu-item-2177 hide-mobile" id="mega-menu-item-2177"><a className="mega-menu-link" href="#" tabIndex={0}>Call Text</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="ast-builder-layout-element ast-flex site-header-focus-item ast-header-button-1" data-section="section-hb-button-1">
                      <div className="ast-builder-button-wrap ast-builder-button-size-default">
                        <a className="ast-custom-button-link" href="https://www.wellnessclinicmarketing.com/get-started/" target="_self" role="button" aria-label="Get Started">
                          <div className="ast-custom-button">Get Started</div>
                        </a>
                        <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/get-started`}>
                          Get Started
                        </Link>
                      </div>
                    </div>
                ...
                <div className="site-header-above-section-right site-header-section ast-flex ast-grid-right-section">
                  <div className="ast-builder-layout-element ast-flex site-header-focus-item ast-header-button-1" data-section="section-hb-button-1">
                    <div className="ast-builder-button-wrap ast-builder-button-size-default">
                      ...
                      <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/get-started`} target="_self">Get Started</Link>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div className="main-navigation">
                      <ul id="ast-hf-mobile-menu" className="main-header-menu ast-nav-menu ast-flex  submenu-with-border astra-menu-animation-fade  stack-on-mobile ast-mega-menu-enabled">
                        ...
                        <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1641">
                          ...
                          <ul className="sub-menu">
                            ...
                            <li className="menu-item menu-item-type-post_type menu-item-object-service menu-item-2031">
                              <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/wellness-medical-clinic-marketing`}>
                                <span className="ast-icon icon-arrow">
                                  <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                  </svg>
                            ...
                            <li className="menu-item menu-item-type-post_type menu-item-object-service menu-item-2032">
                              <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/mens-health-clinic-marketing`}>
                                <span className="ast-icon icon-arrow">
                                  <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                  </svg>
                            ...
                            <li className="menu-item menu-item-type-post_type menu-item-object-service menu-item-2033">
                              <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/med-spa-marketing`}>
                                <span className="ast-icon icon-arrow">
                                  <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                  </svg>
                            ...
                            <li className="menu-item menu-item-type-post_type menu-item-object-service menu-item-2617">
                              <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/multi-location-marketing`}>
                                <span className="ast-icon icon-arrow">
                                  <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                  </svg>
                            ...
                            <li className="menu-item menu-item-type-post_type menu-item-object-service menu-item-3343">
                              <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/ai-search-optimization`}>
                                <span className="ast-icon icon-arrow">
                                  <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                  </svg>
                            ...
                            <li className="menu-item menu-item-type-post_type menu-item-object-service menu-item-3429">
                              <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/franchise-marketing`}>
                                <span className="ast-icon icon-arrow">
                                  <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                  </svg>
                        ...
                        <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2155">
                          <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/our-method-mars`}>
                            <span className="ast-icon icon-arrow">
                              <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                              </svg>
                        ...
                        <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-372">
                          <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/about-us`}>
                            <span className="ast-icon icon-arrow">
                              <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                              </svg>
                          ...
                          <ul className="sub-menu">
                            <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-409">
                              <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/our-team`}>
                                <span className="ast-icon icon-arrow">
                                  <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                  </svg>
                            ...
                            <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-408">
                              <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/events`}>
                                <span className="ast-icon icon-arrow">
                                  <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                  </svg>
                            ...
                            <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-941">
                              <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/webinars`}>
                                <span className="ast-icon icon-arrow">
                                  <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                  </svg>
                            ...
                            <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-942">
                              <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/podcast`}>
                                <span className="ast-icon icon-arrow">
                                  <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                  </svg>
                            ...
                            <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2736">
                              <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/case-study`}>
                                <span className="ast-icon icon-arrow">
                                  <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                  </svg>
                            ...
                            <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1263">
                              <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/blogs`}>
                                <span className="ast-icon icon-arrow">
                                  <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                  </svg>
                            ...
                            <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2853">
                              <Link className="menu-link" to={`${process.env.REACT_APP_BASE_URL}/service/in-the-news`}>
                                <span className="ast-icon icon-arrow">
                                  <svg className="ast-arrow-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enableBackground="new 57 35.171 26 16.043" xmlSpace="preserve">
                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                  </svg>
